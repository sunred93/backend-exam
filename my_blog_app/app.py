...
def seed_db_command(posts):
    ...
    static_posts = [
        ...
        },
        {
            ...
            "content": "Norway's distinct seasons each offer their own unique beauty...",
            "tags": ["seasons", "norway", "nature", "reflection", "beauty"],
            "image_filename": "uploads/images/norway_seasons.jpg" # Example placeholder
        }
    ]
